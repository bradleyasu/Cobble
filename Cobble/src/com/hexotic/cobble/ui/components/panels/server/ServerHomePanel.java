...
public class ServerHomePanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g2d.drawString("Current Time: " + Server.getInstance().getLevelDat().getCurrentTime(), 20, 20);
		g2d.drawString("Seed: " + Server.getInstance().getLevelDat().getSeed(), 20, 40);
		g2d.drawString("Game Type: " + Server.getInstance().getLevelDat().getGameType(), 20, 60);
